...
!function(){function t(t,e,a){if(this.file=t,this.callback=a,this.defaults={quality:.7},a){for(var i in e)this.defaults[i]=e[i];this.defaults.quality>1&&(this.defaults.quality=1)}else this.callback=e;this.results={origin:null,base64:null,base64Len:null},this.init()}window.URL=window.URL||window.webkitURL;var e=detect.parse(navigator.userAgent);t.version="3.1.0",t.prototype={constructor:t,init:function(){var t=this;t.create(t.file,t.callback)},create:function(t,a){var i=this,n=new Image,h=i.results,s="string"==typeof t?t:URL.createObjectURL(t);n.crossOrigin="*",n.onload=function(){function l(t){EXIF.getData(n,function(){var e=EXIF.getTag(this,"Orientation");switch(e){case 3:o.rotate(180*Math.PI/180),o.drawImage(n,-u.w,-u.h,u.w,u.h);break;case 6:w.width=u.h,w.height=u.w,o.rotate(90*Math.PI/180),o.drawImage(n,0,-u.h,u.w,u.h);break;case 8:w.width=u.h,w.height=u.w,o.rotate(270*Math.PI/180),o.drawImage(n,-u.w,0,u.w,u.h);break;default:o.drawImage(n,0,0,u.w,u.h)}t()})}function r(t){w=null,n=null,URL.revokeObjectURL(s),t.base64Len=t.base64.length,a(t)}var o,u=i.resize(this),w=document.createElement("canvas");if(w.width=u.w,w.height=u.h,o=w.getContext("2d"),o.fillStyle="#fff",o.fillRect(0,0,u.w,u.h),h.origin=t,"Android"===e.os.family){if(o.drawImage(n,0,0,u.w,u.h),+e.os.version<4.3){var c=new JPEGEncoder;h.base64=c.encode(o.getImageData(0,0,w.width,w.height),100*i.defaults.quality)}else h.base64=w.toDataURL("image/jpeg",i.defaults.quality);r(h)}else if("iOS"===e.os.family&&+e.os.version<8){var f=new MegaPixImage(n);EXIF.getData(n,function(){f.render(w,{width:w.width,height:w.height})}),l(function(){h.base64=w.toDataURL("image/jpeg",i.defaults.quality),r(h)})}else l(function(){h.base64=w.toDataURL("image/jpeg",i.defaults.quality),r(h)})},n.src=s},resize:function(t){var e=this.defaults.width,a=this.defaults.height,i=t.width/t.height,n={w:t.width,h:t.height};return e&a?(n.w=e,n.h=a):e?(n.w=e,n.h=Math.ceil(e/i)):a&&(n.w=Math.ceil(a*i),n.h=a),n}},window.lrz=function(e,a,i){return new t(e,a,i)}}();