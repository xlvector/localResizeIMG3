...
!function(){function t(t,e,i){if(this.file=t,this.callback=i,this.defaults={quality:.7},i){for(var a in e)this.defaults[a]=e[a];this.defaults.quality>1&&(this.defaults.quality=1)}else this.callback=e;this.results={origin:null,base64:null,base64Len:null},this.init()}window.URL=window.URL||window.webkitURL;var e=detect.parse(navigator.userAgent);t.prototype={constructor:t,init:function(){var t=this;t.create(t.file,t.callback)},create:function(t,i){var a=this,h=new Image,s=a.results,n="string"==typeof t?t:URL.createObjectURL(t);h.src=n,h.crossOrigin="*",h.onload=function(){function r(t){canvas=null,h=null,URL.revokeObjectURL(n),t.base64Len=t.base64.length,i(t)}var w=a.resize(this);EXIF.getData(h,function(){var i,n=EXIF.getTag(this,"Orientation"),l=document.createElement("canvas");if(a.rotateResize(w,n),l.width=w.w,l.height=w.h,i=l.getContext("2d"),i.fillStyle="#fff",i.fillRect(0,0,w.w,w.h),s.origin=t,"iOS"===e.os.family&&+e.os.version<8){var o=new MegaPixImage(h);o.render(l,{width:l.width,height:l.height,orientation:n}),s.base64=l.toDataURL("image/jpeg",a.defaults.quality),r(s)}else{switch(n){case 3:i.rotate(180*Math.PI/180),i.drawImage(h,-w.w,-w.h,w.w,w.h);break;case 6:l.width=w.h,l.height=w.w,i.rotate(90*Math.PI/180),i.drawImage(h,0,-w.h,w.w,w.h);break;case 8:l.width=w.h,l.height=w.w,i.rotate(270*Math.PI/180),i.drawImage(h,-w.w,0,w.w,w.h);break;default:i.drawImage(h,0,0,w.w,w.h)}if("Android"===e.os.family&&e.os.version<4.5){var u=new JPEGEncoder;s.base64=u.encode(i.getImageData(0,0,l.width,l.height),100*a.defaults.quality)}else s.base64=l.toDataURL("image/jpeg",a.defaults.quality);s.base64=l.toDataURL("image/jpeg",a.defaults.quality),r(s)}})}},resize:function(t){var e=this.defaults.width,i=this.defaults.height,a=t.width/t.height,h={w:t.width,h:t.height};return e&i?(h.w=e,h.h=i):e?(h.w=e,h.h=Math.ceil(e/a)):i&&(h.w=Math.ceil(i*a),h.h=i),(h.w>=3264||h.h>=2448)&&(h.w*=.8,h.h*=.8),h},rotateResize:function(t,e){switch(e){case 6:case 8:if(this.defaults.width&&this.defaults.height){var i=t.w,a=t.h;return t.w=a,t.h=i,!1}var h;if(this.defaults.width)return t.w>t.h?(h=t.w-t.h,t.w+=h,t.h+=h):t.w<t.h&&(h=t.h-t.w,t.w-=h,t.h-=h),!1;if(this.defaults.height)return t.w>t.h?(h=t.w-t.h,t.w-=h,t.h-=h):t.w<t.h&&(h=t.h-t.w,t.w+=h,t.h+=h),!1}}},window.lrz=function(e,i,a){return new t(e,i,a)}}();