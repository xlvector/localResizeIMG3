...
!function(){function e(e,t){this.file=e,this.defaults={quality:.7,done:null,fail:null,before:null,always:null};for(var a in t)this.defaults[a]=t[a];this.defaults.quality>1&&(this.defaults.quality=1),this.results={origin:null,base64:null,base64Len:null},this.init()}window.URL=window.URL||window.webkitURL;var t=detect.parse(navigator.userAgent);e.prototype={constructor:e,init:function(){var e=this;if("undefined"==typeof window.URL||"function"!=typeof document.createElement("canvas").getContext){var t=new Error("不支持此设备");return"function"==typeof e.defaults.fail&&e.defaults.fail(t),void("function"==typeof e.defaults.always&&e.defaults.always())}e.create(e.file)},create:function(e){var a=this,i=new Image,n=a.results,l="string"==typeof e?e:URL.createObjectURL(e);i.crossOrigin="*",i.onerror=function(){var e=new Error("图片加载失败");"function"==typeof a.defaults.fail&&a.defaults.fail(e),"function"==typeof a.defaults.always&&a.defaults.always()},i.onload=function(){function s(e){canvas=null,i=null,URL.revokeObjectURL(l),e.base64Len=e.base64.length,"function"==typeof a.defaults.done&&a.defaults.done(e),"function"==typeof a.defaults.always&&a.defaults.always()}var o=a.resize(this);EXIF.getData(i,function(){var l,f=EXIF.getTag(this,"Orientation"),r=document.createElement("canvas");if(r.width=o.w,r.height=o.h,l=r.getContext("2d"),l.fillStyle="#fff",l.fillRect(0,0,o.w,o.h),n.origin=e,"iOS"===t.os.family&&+t.os.version<8){var u=new MegaPixImage(i);u.render(r,{width:r.width,height:r.height,orientation:f}),n.base64=r.toDataURL("image/jpeg",a.defaults.quality),s(n)}else{switch(f){case 3:l.rotate(180*Math.PI/180),l.drawImage(i,-o.w,-o.h,o.w,o.h);break;case 6:r.width=o.h,r.height=o.w,l.rotate(90*Math.PI/180),l.drawImage(i,0,-o.h,o.w,o.h);break;case 8:r.width=o.h,r.height=o.w,l.rotate(270*Math.PI/180),l.drawImage(i,-o.w,0,o.w,o.h);break;default:l.drawImage(i,0,0,o.w,o.h)}if("Android"===t.os.family&&t.os.version.slice(0,3)<4.5){var h=new JPEGEncoder;n.base64=h.encode(l.getImageData(0,0,r.width,r.height),100*a.defaults.quality)}else n.base64=r.toDataURL("image/jpeg",a.defaults.quality);s(n)}})},this.defaults.before(),i.src=l},resize:function(e){var t=this.defaults.width,a=this.defaults.height,i=e.width/e.height,n={w:e.width,h:e.height};return t&a?(n.w=t,n.h=a):t?(n.w=t,n.h=Math.ceil(t/i)):a&&(n.w=Math.ceil(a*i),n.h=a),(n.w>=3264||n.h>=2448)&&(n.w*=.8,n.h*=.8),n}},window.lrz=function(t,a){return new e(t,a)}}();